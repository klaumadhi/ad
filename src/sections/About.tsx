  ...
  return (
    <section id="about" ref={sectionRef} className="relative w-full overflow-hidden bg-void py-28 sm:py-36 md:py-44">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <span className="eyebrow eyebrow-line about-fade">Who We Are</span>
        ...
        <h2 className="mt-6 max-w-3xl font-display text-[9vw] sm:text-[6.5vw] md:text-[4.6vw] font-black uppercase leading-[0.94] tracking-tight text-bone">
          <span className="block overflow-hidden"><span className="about-line block">We Turn Ideas</span></span>
          <span className="block overflow-hidden"><span className="about-line block">Into Digital</span></span>
          <span className="block overflow-hidden"><span className="about-line block text-red">Experiences.</span></span>
        </h2>
        ...
        <div className="about-fade-group mt-10 grid max-w-2xl gap-8 md:mt-14">
          <p className="about-fade text-balance text-base sm:text-lg text-bone/65 leading-relaxed">
            AUTHENTIC DEV is a modern web development studio focused on building high-quality digital
          ...
          <ul className="about-fade grid grid-cols-2 gap-x-6 gap-y-4 sm:grid-cols-4">
            {focusAreas.map((area) => (
              <li key={area} className="border-t border-white/10 pt-3">
                <span className="text-[0.65rem] font-semibold uppercase tracking-widest text-bone/45">{area}</span>
              </li>
            ))}
          </ul>
        </div>
